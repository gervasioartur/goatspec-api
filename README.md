...
```
cd existing_repo
git remote add origin https://gitlab.com/dombo99/goatspec-api.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/dombo99/goatspec-api/-/settings/integrations)
